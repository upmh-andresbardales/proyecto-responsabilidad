...
| CRUD historial de lectura de sensores | Jose Andres Bardales Calva | 2026-04-11 | Por hacer | Parcial | [backend/app/routes/sensors.py](../backend/app/routes/sensors.py) | Hay endpoints de consulta de últimas lecturas, historial y estadísticas. No hay create, update o delete expuestos como CRUD completo. |
| CRUD usuarios y login | Jose Andres Bardales Calva | 2026-04-03 | Por hacer | Pendiente | [backend/app](../backend/app) | No encontré modelo de usuario, autenticación, JWT ni endpoints de login. |
...
| Modelo relacional | David Olvera Gonzalez | 2026-04-02 | Por hacer | Pendiente | [backend/app/models/sensor.py](../backend/app/models/sensor.py) | La solución actual usa MongoDB con Beanie, no un modelo relacional. |
...
| Lanzamiento n8n para trabajar con agentes | Mauro Alberto Ramos Angeles | 2026-04-04 | Por hacer | Pendiente | [docker-compose.yml](../docker-compose.yml) | No encontré servicio n8n en la orquestación ni configuración asociada. |
...
| Investigación condiciones óptimas en hidroponía | Jose Andres Bardales Calva | 2026-04-08 | Por hacer | Pendiente | [README.md](../README.md), [docs/data-reference.md](data-reference.md) | El repo ya codifica umbrales y rangos, pero no encontré un documento claro de investigación como entregable separado. |
...
| Conectar frontend con endpoints de backend | David Olvera Gonzalez | 2026-03-20 | Por hacer | Parcial | [frontend/src/composables/useApi.ts](../frontend/src/composables/useApi.ts), [frontend/src/views/Dashboard.vue](../frontend/src/views/Dashboard.vue) | El cliente Axios y los endpoints ya están definidos, pero el dashboard actual consume principalmente MQTT y no vi uso efectivo del cliente REST en la UI. |
...
| Construir login | Mauro Alberto Ramos Angeles | 2026-03-13 | Por hacer | Pendiente | [frontend/src](../frontend/src) | No encontré vista, formulario o flujo de autenticación en frontend. |
